...
/*void EntreRondas (int, int, int, int, int);*/

void AcomodarDados(int [], int);

///void PuntuacionFinal(int, int);
...
///void PuntuacionFinal(char nombre[], int tama, int Buncos, int TiradasinP, int Lanzamentos, int PuntajeFinal/*,int Total, int Fallidas*/);
...
void EntreRondas(int TiradasFallidas,int Buncos,int RondasActual,int Lanzamientos,int Puntaje) /// Muestre el Puntaje que lleva hasta el momento, ronda, lanzamientos totales y fallidos, buncos conseguidos
{
    system("cls");
    EntreRondas(TiradasFallidas,Buncos,RondasActual,Lanzamientos,Puntaje);
    system("pause");
}
